  ...
  return (
    ...
    >
      ...
      <div className="sidemenu-header">
        <a href="#" className="sidebarlogo" style={{ width: "100%", paddingLeft: "0", display: "flex", justifyContent: "center" }}>
          <img src="/img/edulayne-full-logo.png" alt="Edulayne" style={{ maxHeight: "100px", width: "auto", marginLeft: "-5]0px" }} />
        </a>
