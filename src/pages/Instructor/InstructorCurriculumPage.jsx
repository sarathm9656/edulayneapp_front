...
// Adjust import path for LessonAddForm
...
const InstructorCurriculumPage = () => {
    ...
    useEffect(() => {
        if (courseId) {
            // Check if we should use fetchCourseDetails (might fail if role restricted)
            // Ideally we should use same action if backend allows.
            // If it fails, the title might be missing, but modules should load.
