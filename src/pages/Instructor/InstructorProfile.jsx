...
const InstructorProfile = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            console.log("Debug - User.user.user_id:", user?.user_id);
            console.log("Debug - User role:", user?.role_id?.name);
            console.log("Debug - Price per hour (old path):", user?.user_id?.price_per_hour);
            console.log("Debug - Price per hour (new path):", user?.price_per_hour);
            console.log("Debug - Price per hour type:", typeof user?.price_per_hour);
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input
                                                type="text"
                                                className="form-control"
                                                value={user?.tenant_id?.name || "Loading..."}
                                                disabled={true}
                                                style={{
                                                    backgroundColor: '#f8f9fa',
                                                    border: '1px solid #e9ecef',
                                        ...
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input
                                                type="text"
                                                className="form-control"
                                                value={`$${user?.price_per_hour || 0}/hour`}
                                                disabled={true}
                                                style={{
                                                    backgroundColor: '#f8f9fa',
                                                    border: '1px solid #e9ecef',
