                            ...
                            <div className="card position-relative" style={{
                                ...
                                <div className="text-center mb-4">
                                    <div className="profile-avatar" style={{
                                        ...
                                        {user?.user_id?.fname?.charAt(0)?.toUpperCase() || 'S'}
                                    </div>
                                ...
                                <div className="profile-info">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <p className="form-control-plaintext">{user?.user_id?.phone_number || 'N/A'}</p>
                                    </div>
                                    <div className="mb-3">
                                        <label className="form-label fw-bold">Date of Birth</label>
                                        <p className="form-control-plaintext">
                                            {user?.user_id?.dob ? new Date(user.user_id.dob).toLocaleDateString() : 'N/A'}
                                        </p>
                                    </div>
                                    <div className="mb-3">
