            ...
            <div className="d-flex gap-2">
              ...
              <div className="dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 mt-2">
                  <li><button className="dropdown-item py-2 px-3" onClick={() => setIsAddCategoryModalOpen(true)}><i className="fa-solid fa-list-ul me-2 text-primary"></i> Categories</button></li>
                  <li><button className="dropdown-item py-2 px-3" onClick={() => setIsAddSubcategoryModalOpen(true)}><i className="fa-solid fa-indent me-2 text-info"></i> Subcategories</button></li>
                  <li><button className="dropdown-item py-2 px-3" onClick={() => setIsAddLevelModalOpen(true)}><i className="fa-solid fa-layer-group me-2 text-success"></i> Levels</button></li>
                  <li><button className="dropdown-item py-2 px-3" onClick={() => setIsAddLanguageModalOpen(true)}><i className="fa-solid fa-language me-2 text-warning"></i> Languages</button></li>
                </ul>
              </div>
